...
为准，不在本文件复制 allowed scope。#138/#140 已完成 audit/public contract，
#152 已在授权根下冻结本地 calibration/blind holdout 并关闭。当前 linked issue
#155 只实现 deterministic classifier core 和 frozen public-synthetic tests；
storage/index admission、OCR wiring 与 private calibration 必须由后续 linked
issue 重新 observe。除非对应 evidence lane 已满足，
本目标仍不允许运行或提交私有 D10K
