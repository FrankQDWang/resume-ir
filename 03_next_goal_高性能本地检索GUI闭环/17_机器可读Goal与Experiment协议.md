...
3. #138 product-capability audit 已完成；#140 仍负责冻结 mixed-directory benchmark、anti-overfit evidence contract、public schema/fixtures 和 CI harness。当前临时 active slice #145 只授权 pinned issue-centric atomic #140 -> #145 contract-plus-test recovery；它保持在正常 PR budget 内且不使用 scope exception，不授权 classifier、private mixed-root、GUI、query hot-path、新 L4 或 profile work；#145 main-reachable 后必须恢复 #140、刷新 PR #144，再继续 #143/#142。
