...
3. #138 product-capability audit 已完成；#140 仍负责冻结 mixed-directory benchmark、anti-overfit evidence contract、public schema/fixtures 和 CI harness。当前临时 active slice #143 只授权独立 test-only redaction-counter 竞态修复，不授权 classifier、private mixed-root、GUI、query hot-path、新 L4 或 profile work；#143 main-reachable 后必须先用独立合同 PR 恢复 #140，再刷新 PR #142。
