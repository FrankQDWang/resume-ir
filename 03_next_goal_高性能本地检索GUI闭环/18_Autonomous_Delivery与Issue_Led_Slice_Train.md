...
anti-overfit evidence layers。PR #144 的 #143 authorization 已冻结；当前临时
active slice #145 以独立 contract PR 授权、再以独立 Rust PR 把 parse-result
cancel-poll test 改成 deterministic handshake，且不改变 production semantics。
#145 main-reachable 后必须恢复 #140、刷新 PR #144，再继续 #143/#142；后续新
issue 才实现 precision-first classifier。#140 仍不执行或声明
