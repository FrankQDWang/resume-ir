...
def main() -> int:
    ...
    require_string(
        ...
        "make_parse_result_cancel_poll_test_scheduler_independent",
        "scope.active_slice.name",
    )
    linked_spec = "docs/superpowers/specs/2026-07-10-parse-result-cancel-poll-test-isolation.md"
    linked_plan = "docs/superpowers/plans/2026-07-10-parse-result-cancel-poll-test-isolation.md"
