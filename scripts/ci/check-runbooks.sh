...
require_text "$worker_runbook" "command -v tesseract"
require_text "$worker_runbook" "command -v pdftoppm"
require_text "$worker_runbook" "flags are omitted"
...
require_text "$worker_runbook" "scripts/local/prepare-local-ocr-runtime-manifest.sh"
...
require_text "$worker_runbook" "--language eng+chi_sim"
require_text "$worker_runbook" "--language-pack eng=<local-eng-tessdata-file>"
require_text "$worker_runbook" "--language-pack chi_sim=<local-chi-sim-tessdata-file>"
...
require_text "$release_runbook" "For Tesseract combined languages such as \`eng+chi_sim\`"
require_text "$release_runbook" "--language-pack <lang>=<local-tessdata-file>"
require_text "$release_runbook" "[--tesseract-command <local-tesseract-command>]"
require_text "$release_runbook" "[--pdftoppm-command <local-pdftoppm-command>]"
require_text "$release_runbook" "uses \`command -v tesseract\`"
require_text "$release_runbook" "\`command -v pdftoppm\`"
require_text "$release_runbook" "Pass explicit command"
require_text "$release_runbook" "paths only when pinning"
...
require_text "$worker_runbook" "PDFium remains the preferred bundled renderer candidate"
