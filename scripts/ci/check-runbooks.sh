...
require_text "$closure_report" "Current-stage status: closed with blocked handoff"
require_text "$closure_report" "P0_foundation"
require_text "$closure_report" "P1_text_import_fulltext"
require_text "$closure_report" "P2_fields_dedupe"
require_text "$closure_report" "P3_semantic_vector"
require_text "$closure_report" "P4_ocr"
require_text "$closure_report" "P5_cross_platform_release"
require_text "$closure_report" "P6_performance_stability"
require_text "$closure_report" "S438"
require_text "$closure_report" "S439"
require_text "$closure_report" "8720 documents"
require_text "$closure_report" "8553 OCR-required"
require_text "$closure_report" "20 failed-permanent"
...
require_text "$complete_product_report" "git log 摘要"
require_text "$complete_product_report" "git status"
require_text "$complete_product_report" "P0_foundation"
require_text "$complete_product_report" "P1_text_import_fulltext"
require_text "$complete_product_report" "P2_fields_dedupe"
require_text "$complete_product_report" "P3_semantic_vector"
require_text "$complete_product_report" "P4_ocr"
require_text "$complete_product_report" "P5_cross_platform_release"
require_text "$complete_product_report" "P6_performance_stability"
...
require_text "$complete_product_report" "7353450 test: cover verified release gate readiness"
require_text "$complete_product_report" "ba3f2b8 docs: document verified release gate semantics"
require_text "$complete_product_report" "7517df5 fix: preserve current-stage handoff sentinels"
require_text "$complete_product_report" "7f8e406 test: require current-stage redaction sentinels"
require_text "$complete_product_report" "codex/fault-injection-diagnostics...origin/codex/fault-injection-diagnostics"
