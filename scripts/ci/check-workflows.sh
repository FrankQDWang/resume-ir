...
require_text "$release_workflow" "Create synthetic reviewed runtime bundle dry run"
...
require_text "$release_workflow" "--runtime-bundle-manifest release-dry-run/runtime-bundle-manifest.json"
