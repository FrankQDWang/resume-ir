...
- S1-S12 foundation code has been rebuilt in the current worktree: `Cargo.toml`,
  ...
  skeleton crates that do not run OCR.
...
- `PROGRESS.md` records S0 through S12 as complete while P0/P1/P2/P3 remain incomplete
  and P4 remains blocked for real OCR execution.
