...
`GOAL.md`. It is intentionally stricter than the S0-S19 long-running execution
...
- S1-S19 foundation code has been rebuilt in the current worktree: `Cargo.toml`,
...
- `PROGRESS.md` records S0 through S19 as complete while P0/P1/P2/P3/P6 remain
