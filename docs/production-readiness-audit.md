...
`GOAL.md`. It is intentionally stricter than the S0-S17 long-running execution
...
- S1-S17 foundation code has been rebuilt in the current worktree: `Cargo.toml`,
  ...
  and local failure diagnostics out of public debug/status output.
...
- `PROGRESS.md` records S0 through S17 as complete while P0/P1/P2/P3/P6 remain
