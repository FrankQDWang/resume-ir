...
use crate::{
    ...
    schema_v35, schema_v36, schema_v37, schema_v38, schema_v39, MetaStoreError, Result,
};
...
impl InitializationGeneration {
    pub(super) const RECOVERABLE: [Self; 5] =
        [Self::V35, Self::V36, Self::V37, Self::V38, Self::V39];
