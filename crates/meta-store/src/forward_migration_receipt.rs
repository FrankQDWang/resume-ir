...
use crate::{
    ...
    schema_v37, schema_v38, schema_v39, MetaStoreError, Result,
};
...
fn validate(receipt: &MigrationReceipt) -> Result<()> {
    ...
    let prior_v38_pair = matches!(
        ...
        schema_v29::VERSION
            ...
            | schema_v36::VERSION
            | schema_v37::VERSION
    ) && receipt.target.schema_version == schema_v38::VERSION
        && receipt.staging_file == current_staging;
    let current_pair = matches!(
        ...
        schema_v29::VERSION
            ...
            | schema_v37::VERSION
            | schema_v38::VERSION
    ) && receipt.target.schema_version == schema_v39::VERSION
        && receipt.staging_file == current_staging;
    if (!legacy_v30_pair
        && !prior_v35_pair
        && !prior_v36_pair
