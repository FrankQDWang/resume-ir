...
fn status_can_read_redacted_daemon_status_over_loopback_ipc() {
    ...
    let server = thread::spawn(move || {
        ...
        let body = "{\"schema_version\":\"daemon.status.v1\",\"status\":\"ok\",\"index_health\":\"ready\",\"import_tasks_queued\":0,\"import_tasks_cancelled\":1,\"ocr_page_budget_blocked\":1,\"latest_import_scan\":{\"files_discovered\":9,\"ignored_entries\":2,\"scan_errors\":1,\"searchable_documents\":4,\"ocr_required_documents\":1,\"ocr_jobs_queued\":1,\"failed_documents\":1,\"deleted_documents\":0,\"scan_budget_observed\":9,\"scan_budget_limit\":10,\"scan_budget_exhausted\":false}}";
        write!(
            stream,
