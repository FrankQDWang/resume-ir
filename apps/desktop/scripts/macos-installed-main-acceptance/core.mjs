...
export const ACCEPTANCE_SCHEMA = "resume-ir.macos-installed-main-acceptance.v4";
export const AUTHORIZED_SOURCE_SCHEMA = 29;
export const INSTALLED_TARGET_SCHEMA = 34;
...
export const RELEASE_PROMOTION_TIMEOUT_MS = 20 * 60_000;
